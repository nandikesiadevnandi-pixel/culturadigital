...
export const quizQuestions: QuizQuestion[] = [
  ...
  // ===== MÓDULO A — HTML =====
  {
    number: 23,
    type: "multiple_choice",
    prompt: "A Ana quer criar uma página sobre sua cidade favorita. Ela colocou o texto do título dentro de uma tag e ele aparece na aba do navegador, não na página. Em qual tag ela colocou?",
    options: [
      { key: "A", text: "<h1>" },
      { key: "B", text: "<body>" },
      { key: "C", text: "<title>" },
  ...
  },
  {
    number: 24,
    type: "multiple_choice",
    prompt: "Carlos quer que a palavra CAMPEÃO apareça em negrito no meio de um parágrafo. O que ele deve usar?",
    options: [
      { key: "A", text: "Uma tag <b> separada do parágrafo" },
      { key: "B", text: "Escrever a palavra em maiúsculas dentro do <p>" },
      { key: "C", text: "Envolver a palavra com <strong> dentro do <p>" },
      { key: "D", text: "Criar um novo <h2> só para essa palavra" },
    ],
    correct: "C",
  },
  {
    number: 25,
    type: "multiple_choice",
    prompt: "Miguel quer criar um link que leva para o site do time dele. Qual é o código correto?",
    options: [
      { key: "A", text: "<a>Visite o Flamengo href='flamengo.com'</a>" },
      { key: "B", text: "<link href='flamengo.com'>Visite o Flamengo</link>" },
      { key: "C", text: "<a href='https://flamengo.com.br'>Visite o Flamengo</a>" },
      { key: "D", text: "<url='flamengo.com'>Visite o Flamengo</url>" },
    ],
    correct: "C",
  },
  // ===== MÓDULO B — CSS =====
  {
    number: 26,
    type: "multiple_choice",
    prompt: "A professora quer que todos os parágrafos fiquem azul escuro sem adicionar um atributo em cada parágrafo. Qual abordagem de CSS resolve isso de uma vez?",
    options: [
      { key: "A", text: "Criar .azul e adicionar class='azul' em cada parágrafo" },
      { key: "B", text: "Usar p { color: darkblue; } no CSS" },
      { key: "C", text: "Adicionar style='color:darkblue' em cada parágrafo" },
      { key: "D", text: "Colocar todos os parágrafos dentro de uma div azul" },
    ],
    correct: "B",
  },
  {
    number: 27,
    type: "multiple_choice",
    prompt: "Beatriz está ajustando um card. Ela quer que o texto não fique colado nas bordas. Qual propriedade CSS resolve isso?",
    options: [
      { key: "A", text: "margin" },
      { key: "B", text: "padding" },
      { key: "C", text: "border" },
  ...
  },
  {
    number: 28,
    type: "multiple_choice",
    prompt: "Miguel criou 4 cards que aparecem um embaixo do outro, mas quer que fiquem lado a lado. Qual propriedade CSS, aplicada ao container, resolve isso?",
    options: [
      { key: "A", text: "text-align: center" },
      { key: "B", text: "float: left em cada card" },
      { key: "C", text: "display: flex no container" },
      { key: "D", text: "width: 25% em cada card" },
    ],
    correct: "C",
  },
];

export const MAX_AUTO_SCORE = quizQuestions.length; // 28

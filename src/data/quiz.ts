...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    number: 25,
    type: “multiple_choice”,
    prompt: “Miguel quer criar um link 'Visite o Flamengo' que leva para o site do time. Qual é o código correto?”,
    options: [
  ...
  // ===== MÓDULO B — CSS =====
  {
    number: 26,
    type: “multiple_choice”,
    prompt: “A professora quer que todos os parágrafos fiquem azul escuro sem adicionar um atributo em cada <p>. Qual abordagem de CSS resolve isso de uma vez?”,
    options: [
      { key: “A”, text: “Criar .azul e adicionar class='azul' em cada <p>” },
      { key: “B”, text: “Usar p { color: darkblue; } no CSS” },
      { key: “C”, text: “Adicionar style='color:darkblue' em cada <p>” },
      { key: “D”, text: “Colocar todos os parágrafos dentro de <blue>” },
    ],
    correct: “B”,
  },
  {
